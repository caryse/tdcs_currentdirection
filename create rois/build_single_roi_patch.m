...
SUBJ_PATH = '/Users/carysevans/Desktop/directionWlkthru/Joyce/';                                     %surface path
...
slashIdx = strfind(SUBJ_PATH, '/');
subj = extractBetween(SUBJ_PATH, (slashIdx(1,end-1)+1),(slashIdx(1,end)-1));
...
for s = 1:length(subj)
  ...
  % get subj. path and load surface
    surfPATH = [SUBJ_PATH, 'surf/']; %subject folder within surface path   
    sl = gifti([surfPATH 'ro_white-pial.gii']);
