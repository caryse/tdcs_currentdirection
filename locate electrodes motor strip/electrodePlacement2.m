function [hdrInfo, myelectrodecoordA, myelectrodecoordC] = electrodePlacement2(P1,P2,T2,elecNeeded,options,uniTag)
...
myelectrodecoordA = electrode_coord(2,:);
myelectrodecoordC = electrode_coord(1,:);
