function  [myelectrodecoordA, myelectrodecoordC] = roast2(subj,recipe,varargin)
...
% if ~exist([dirname filesep baseFilename '_' uniqueTag '_mask_elec.nii'],'file')
    ...
    [hdrInfo, myelectrodecoordA, myelectrodecoordC] = electrodePlacement2(subj,subjRasRSPD,T2,elecName,options,uniqueTag);
